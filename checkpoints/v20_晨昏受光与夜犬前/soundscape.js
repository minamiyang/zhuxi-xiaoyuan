...
const titles={morning:'清晨鸟鸣',hen:'母鸡咯咯',chicks:'小鸡叽叽',ducks:'鸭子戏水',river:'小河流水',evening:'归巢鸟鸣',night:'夜间虫鸣',rooster:'公鸡打鸣'};
...
export function createSoundscape(){
 ...
 let muted=false,disposed=false,lastLabel='',lastInput=null,dawnLatched=false;const tracks=new Map(),failures=[];
 for(const [id,title]of Object.entries(titles)){const gain=ctx.createGain();gain.gain.value=0;gain.connect(master);tracks.set(id,{id,title,gain,target:0,buffer:null,normalization:1,source:null,loaded:false,timer:0,oneShot:id==='rooster',pending:false,active:false,playCount:0});}
