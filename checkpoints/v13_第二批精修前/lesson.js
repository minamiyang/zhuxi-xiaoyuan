...
const garden=shot([-10,6.5,10],[-3.5,1.85,1.4],2.6);
const shots=[garden,shot([-3,4.8,10],[.3,.8,3.55],2.9),shot([-10,4.2,5],[-5.15,.85,.7],3.2),shot([-4.5,4.6,8],[-1.15,.9,2.8],3.0),shot([8.5,6.8,8],[3.35,1,.2],2.35),shot([-.4,4.7,8],[.4,1.25,.95],2.85),shot([-10,7,10],[-2.8,2,1],2.1),shot([-13.8,12.4,15],[0,1.95,0],1)];
